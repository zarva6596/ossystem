...
const NewProduct = ({ addNewProduct, products, user }) => {
...
const putActionsToProps = dispatch => ({
  addNewProduct: bindActionCreators(addProduct, dispatch),
});

export default connect(putStateToProps, putActionsToProps)(NewProduct);
